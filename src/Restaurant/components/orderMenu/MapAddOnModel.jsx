            ...
            <SheetContent className="h-full max-w-[770px] w-full">
                <Form {...form}>
                    <form onSubmit={handleSubmit(onsubmit)} className='flex flex-col justify-between h-full'>
                        <div>
                            <h2 className='text-[#000000] text-2xl font-semibold font-inter'>Addon</h2>
                        ...
                        <Button type="submit" size="lg" variant="capsico" className="w-full class-base2">Add Addon</Button>
                    </form>
                </Form>
            </SheetContent>
        </Sheet>
