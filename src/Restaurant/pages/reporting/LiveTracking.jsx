      ...
      <div className="bg-white p-6 rounded-xl">
        <div className="flex justify-between items-center">
          <div className="flex gap-2 items-center">
            ...
            <h4 className="font-semibold text-[#4A5E6D] text-lg font-numans">Businesss Overview</h4>
      ...
      <div className="bg-white p-6 mt-6 rounded-xl">
        <div className="flex justify-between items-center">
          <div className="flex gap-2 items-center">
            ...
            <h4 className="font-semibold text-[#4A5E6D] text-lg font-numans">User Experience</h4>
            <img src={informationIcon} alt="" />
          </div>
          <div>
            <button className="font-semibold flex text-lg text-[#1AA6F1] font-numans">
      ...
      <div className="bg-white p-6 mt-6 rounded-xl">
        <div className="flex justify-between items-center">
          <div className="flex gap-2 items-center">
            ...
            <h4 className="font-semibold text-[#4A5E6D] text-lg font-numans">User Funnel</h4>
            <img src={informationIcon} alt="" />
          </div>
          <div>
            <button className="font-semibold flex text-lg text-[#1AA6F1] font-numans">
