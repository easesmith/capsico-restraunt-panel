      ...
      {isOpen && (
        <div className="pl-6 mt-2 w-[400px] max-w-[400px]">
          {section.items.map((item, idx) => (
            <div key={idx} className="flex justify-between items-center py-1">
              <div className="flex items-center">
                ...
                <span className="text-[#323F49] class-base1">{item.name}</span>
              </div>
          ...
          <div className="w-[553px] flex flex-wrap gap-4 mt-2">
            <button className="flex items-center gap-3"><FiPlusCircle className="primary-color text-2xl" /><span className="text-[#000000] text-xl font-normal font-numans">Add food item</span></button>
            <button className="flex items-center gap-3"><FiPlusCircle className="primary-color text-2xl" /><span className="text-[#000000] text-xl font-normal font-numans">Arrange Existing item</span></button>
            <button className="flex items-center gap-3"><FiPlusCircle className="primary-color text-2xl" /><span className="text-[#000000] text-xl font-normal font-numans">Add food item</span></button>
          </div>
        </div>
      )}
