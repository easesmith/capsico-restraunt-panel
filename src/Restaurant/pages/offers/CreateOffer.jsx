...
const CreateOffer = () => {
  ...
  useEffect(() => {
    if (watch("offerType") === "comboDeals" && watch("restaurantId")) {
      getItemsByRestaurant();
    }
  }, [watch("restaurantId"), watch("offerType")]);
  ...
  const onSubmit = (data) => {
    ...
    addCoupon(`/offers/create-offer`, apiData);
  };
        ...
        <Form {...form}>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {watch("scope") === "itemwise" && watch("categoryId") && (
                <FormField
                  control={control}
