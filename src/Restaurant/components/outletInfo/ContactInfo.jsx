    ...
    <div className="p-5">
      <div className="w-full relative">
        ...
        <Input
          ...
          className="px-4 pl-8 w-full secondry-color class-sm2 placeholder:text-[#667085]"
        />
      </div>
      ...
      <div className="flex justify-between items-center mt-4 p-4 border-b border-b-[#DAE1E7]">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="class-lg1 text-[#323F49]">
        ...
        <div>
          <FiEdit2
            ...
            className="text-[#1AA6F1] text-xl cursor-pointer"
          />
        </div>
      </div>
      ...
      <div className="flex justify-between items-center px-4 py-2 border-b border-b-[#DAE1E7]">
        <div className="class-sm1 text-[#323F49]">
          No one added as staff yet. Invite someone now.
        </div>
        <div>
          <Button variant="capsico" className="rounded-[1px] px-7 class-base3">
            Invite user
          </Button>
        </div>
      </div>
      ...
      {isDeleteContactModalOpen && (
        <DeleteModal
          isDeleteModalOpen={isDeleteContactModalOpen}
          setIsDeleteModalOpen={setIsDeleteContactModalOpen}
          onDelete={() => {}}
        />
      )}
    </div>
