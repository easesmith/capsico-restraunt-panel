    ...
    return (
        <section className=' sticky top-[105px] w-[280px] h-[calc(100vh-105px)] overflow-y-auto overflow-x-visible'>
            <div className='flex flex-col gap-4 bg-[#FFFFFF] border-[1px] border-[#E7EBEF] px-5 py-16'>
                ...
                <Link to="/restaurant/menu" className={`flex justify-start items-center gap-[14px] h-[52px] p-[14px] cursor-pointer group hover:bg-[#F3F3FC] ${pathname.includes("/restaurant/menu") ? 'text-[#1AA6F1] bg-[#F3F3FC]' : 'text-[red]'}`}>
                ...
                <Link to="/restaurant/offer" className={`flex justify-start items-center gap-[14px] h-[52px] p-[14px] cursor-pointer group hover:bg-[#F3F3FC] ${pathname.includes("/restaurant/offer") ? 'text-[#1AA6F1] bg-[#F3F3FC]' : 'text-[red]'}`}>
                ...
                <Link to="/restaurant/payout" className={`flex justify-start items-center gap-[14px] h-[52px] p-[14px] cursor-pointer group hover:bg-[#F3F3FC] ${pathname.includes("/restaurant/payout") ? 'text-[#1AA6F1] bg-[#F3F3FC]' : 'text-[red]'}`}>
                    <img src={PayoutImg} alt="" className='w-[24px] h-[24px]' />
                    <span className={` text-[16.8px] font-normal font-inter ${pathname.includes("/restaurant/payout") ? 'text-[#1AA6F1]' : 'text-[#637D92]'} group-hover:text-[#1AA6F1]`}>Payout</span>
                </Link>
                <Link to="/restaurant/reporting" className={`flex justify-start items-center gap-[14px] h-[52px] p-[14px] cursor-pointer group hover:bg-[#F3F3FC] ${pathname.includes("/restaurant/reporting") ? 'text-[#1AA6F1] bg-[#F3F3FC]' : 'text-[red]'}`}>
                    <img src={ReportingImg} alt="" className='w-[24px] h-[24px]' />
                ...
                <Link to="/restaurant/outlet" className={`flex justify-start items-center gap-[14px] h-[52px] p-[14px] cursor-pointer group hover:bg-[#F3F3FC] ${pathname.includes("/restaurant/outlet") ? 'text-[#1AA6F1] bg-[#F3F3FC]' : 'text-[red]'}`}>
